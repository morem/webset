...
<!-- buttons with icons -->
<button class="ym-button ym-email">text</button>
...
<div class="ym-contain-oh">Avoid this method if you use e.g. CSS3 box-shadows on child elements, as these shadows will be clipped as well.
</div>
    </main>
	    <footer>
